...
import {
  ...
  RefreshCw, FileText, ScanSearch, Filter,
} from 'lucide-react';
...
const inspectionPhotos = [
  {
    ...
    analysis: { workers: 3, helmets: 3, vests: 2, gloves: 3, violations: ['Gilet de sécurité manquant - Ouvrier #2'] },
    status: 'violation',
  },
  {
    ...
    analysis: { workers: 2, helmets: 2, vests: 2, gloves: 2, violations: [] },
    status: 'compliant',
  },
  {
    ...
    analysis: { workers: 5, helmets: 4, vests: 5, gloves: 3, violations: ['Casque manquant - Ouvrier #4', 'Gants manquants - 2 ouvriers'] },
    status: 'violation',
  },
  {
    ...
    analysis: { workers: 8, helmets: 8, vests: 8, gloves: 8, violations: [] },
    status: 'compliant',
  },
];
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                ...
                { label: 'Coordonnées GPS',  value: `${selected.location.lat.toFixed(4)}, ${selected.location.lng.toFixed(4)}` },
              ].map(m => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Ouvriers Détectés',      value: selected.analysis.workers,  check: null },
                  { label: 'Casques Détectés',       value: selected.analysis.helmets,  check: selected.analysis.helmets === selected.analysis.workers },
                  { label: 'Gilets Détectés',  value: selected.analysis.vests,    check: selected.analysis.vests === selected.analysis.workers },
                  { label: 'Gants Détectés',        value: selected.analysis.gloves,   check: selected.analysis.gloves === selected.analysis.workers },
                ].map(item => (
          ...
          {selected.analysis.violations.length === 0 && (
            <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5 flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-emerald-600 text-xs mt-0.5">Aucune violation de sécurité n'a été détectée sur cette photo. Conformité totale confirmée.</div>
              </div>
            </div>
          )}
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Btn color="slate"   icon={<MapPin size={15}/>}     label="Voir sur le plan"/>
